...
import { FaUserCircle, FaUserTie, FaRegAddressCard, FaClipboardList } from 'react-icons/fa';
...
const AdminHome = () => {
  ...
  const menuItems = [
    { title: "Dashboard", icon: <MdSpaceDashboard size={26} />, path: "/admin/dashboard" },
    { title: "Employees", icon: <FaUserTie size={26} />, path: "/admin/employees" },
